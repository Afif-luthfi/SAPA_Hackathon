    ...
    <div className={`app-shell${largeText ? ' large-text' : ''}${highContrast ? ' high-contrast' : ''}`}>
      ...
      <div className="main-shell">
        ...
        <main id="main" className="page-content">
          ...
          <footer className="page-footer"><span>sapa<span className="brand-dot">.</span> <span>Akses komunikasi sejak pintu pertama.</span></span><span><a href="#dataset" aria-label="Studio Dataset untuk tim">Studio Dataset ↗</a></span></footer>
        </main>
      </div>
